...
export const INITIAL_STATE: Partial<StudioState> = {
  ...
  filters: [
    // Page 1 KPI date filters — "Last 12 months" window used for trend comparisons
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-kpi-revenue' },
    ...
    },
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-kpi-orders' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: ORDERS_SOURCE_ID,
    },
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-kpi-customers' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: ORDERS_SOURCE_ID,
    },
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-kpi-avg-discount' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: ORDERS_SOURCE_ID,
    },
    // Page 2 (Products) KPI date filters
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-kpi2-margin' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: ORDERS_SOURCE_ID,
    },
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-kpi2-units-sold' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: ORDERS_SOURCE_ID,
    },
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-chart2-stock-by-category' },
    },
    // Page 3 (Logistics) KPI date filters
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-kpi3-items-shipped' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
    ...
    },
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-kpi3-ontime' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: SHIPMENTS_SOURCE_ID,
    },
    {
      ...
      rankByField: 'total',
      filterSourceId: ORDERS_SOURCE_ID,
      scope: { kind: 'widget' as const, widgetId: 'widget-chart3-orders-by-country' },
    },
    // Page 4 (Customers)
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-kpi4-enterprise' },
    },
    {
      ...
      rankByField: 'total',
      filterSourceId: ORDERS_SOURCE_ID,
      scope: { kind: 'widget' as const, widgetId: 'widget-chart4-top-customers' },
    },
    {
      ...
      rankByField: 'total',
      filterSourceId: ORDERS_SOURCE_ID,
      scope: { kind: 'widget' as const, widgetId: 'widget-grid4-top-customers' },
    },
    // Page 6 KPI date filters — "Last 12 months" window for CRM Pipeline KPIs
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-kpi6-open-deals' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
    ...
    },
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-kpi6-pipeline-value' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: CRM_DEALS_SOURCE_ID,
    },
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-kpi6-win-rate' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: CRM_DEALS_SOURCE_ID,
    },
    // Page 7 KPI date filter — "Last 12 months" window for Activities Logged trend
    {
      ...
      scope: { kind: 'widget' as const, widgetId: 'widget-kpi7-open-activities' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
