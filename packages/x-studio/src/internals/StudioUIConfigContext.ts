...
export function useStudioFeatures(): Required<StudioFeatureFlags> {
  ...
  return {
    ...
    allowGrid: featureFlags.allowGrid ?? true,
    allowChart: featureFlags.allowChart ?? true,
    allowKpi: featureFlags.allowKpi ?? true,
    allowText: featureFlags.allowText ?? true,
    allowFilter: featureFlags.allowFilter ?? true,
    allowPivot: featureFlags.allowPivot ?? true,
    allowMap: featureFlags.allowMap ?? true,
    ...
    drilldown: featureFlags.drilldown ?? true,
  };
}
