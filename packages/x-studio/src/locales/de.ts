...
export const deLocaleText: Partial<StudioLocaleText> = {
  ...
  filterLinkToField: 'Link zum Feld',
  filterRemoveFieldLink: 'Link zum Feld entfernen',
  ...
  filterMetricRowLabel: 'Metrische Linie',
  filterMetricHelperText: 'Identifiziert die Zeile in der Geschäftsmetriktabelle',
  filterFieldLabel: 'Feld',
  filterRankByLabel: 'Sortieren nach',
  filterMetricCurrentValue: 'Aktueller Wert:',
