...
/**
 * Saves the active page's page-level filters as a named preset. The `id` is generated by
 * the caller (a `Date.now()`-based side effect the controller owns) so it can also be
