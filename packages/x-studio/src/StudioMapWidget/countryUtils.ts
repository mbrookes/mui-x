...
export const NUMERIC_TO_ALPHA2: Record<number, string> = {
  ...
  458: 'MY', 462: 'MV', 466: 'ML', 474: 'MQ', 478: 'MR', 480: 'MU', 484: 'MX',
  ...
  642: 'RO', 643: 'RU', 646: 'RW', 659: 'KN', 662: 'LC', 670: 'VC', 678: 'ST',
  682: 'SA', 686: 'SN', 688: 'RS', 690: 'SC', 694: 'SL', 703: 'SK', 704: 'VN',
...
const STATE_NAME_TO_ABBR: Record<string, string> = {
  ...
  wyoming: 'WY', 'american samoa': 'AS', guam: 'GU', 'puerto rico': 'PR',
...
export const EUROPEAN_ALPHA2_CODES = new Set<string>([
  ...
  'FR', 'GE', 'DE', 'GR', 'HU', 'IS', 'IE', 'IT', 'LV', 'LI', 'LT', 'LU', 'MT',
