...
export const INITIAL_STATE: Partial<StudioState> = {
  ...
  widgets: {
    ...
    'widget-chart3-shipments-gantt': {
      id: 'widget-chart3-shipments-gantt',
      kind: 'chart',
      ...
      config: {
        chartType: 'gantt',
        ganttLabelField: 'carrier',
        ganttStartField: 'shipDate',
        ganttEndField: 'estimatedDeliveryDate',
        ganttColorField: 'status',
      },
    },
