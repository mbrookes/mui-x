...
export const esLocaleText: Partial<StudioLocaleText> = {
  ...
  quickFilterBarClearAll: 'Borrar todos los filtros de página',
  ...
  aiSummaryTitle: 'Resumen del panel',
  aiSummarizeTooltip: 'Resumir panel',
  ...
  filterLinkToField: 'Enlace al campo',
  filterRemoveFieldLink: 'Eliminar enlace al campo',
  ...
  filterMetricRowLabel: 'Línea métrica',
  filterMetricHelperText: 'Identifica la fila en la tabla de métricas comerciales.',
  filterFieldLabel: 'Campo',
  filterRankByLabel: 'Ordenar por',
  filterMetricCurrentValue: 'Valor actual:',
