...
export const esLocaleText: Partial<StudioLocaleText> = {
  ...
  pivotRowsTruncatedNotice: (shown, total) =>
    `Mostrando las primeras ${shown} de ${total} categorías de filas.`,
  pivotColumnsTruncatedNotice: (shown, total) =>
    `Mostrando las primeras ${shown} de ${total} categorías de columnas.`,
  ...
  chatApprovalWillRemoveWidgets: 'Eliminará estos widgets',
  chatApprovalWillRemovePages: 'Eliminará estas páginas',
  ...
  chatApprovalInputWithheld:
    'Los detalles de esta solicitud eran demasiado grandes para mostrarse, por lo que no se enumera ningún argumento. Rechaza esta solicitud a menos que sepas lo que hace.',
  ...
  canvasWidgetKeyboardHint:
    'Use las teclas de flecha para mover este widget, Supr para eliminarlo, Intro para seleccionarlo.',
