...
export const INITIAL_STATE: Partial<StudioState> = {
  ...
  filters: [
    // Page 1 KPI date filters — "Last 12 months" window used for trend comparisons
    {
      ...
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-kpi-revenue' },
    ...
    },
    {
      ...
      isDashboardDateRange: true as const,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-kpi-orders' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: ORDERS_SOURCE_ID,
    },
    {
      ...
      isDashboardDateRange: true as const,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-kpi-customers' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: ORDERS_SOURCE_ID,
    },
    {
      ...
      isDashboardDateRange: true as const,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-kpi-avg-discount' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: ORDERS_SOURCE_ID,
    },
    // Page 2 (Products) KPI date filters
    {
      ...
      isDashboardDateRange: true as const,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-kpi2-margin' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: ORDERS_SOURCE_ID,
    },
    {
      ...
      isDashboardDateRange: true as const,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-kpi2-units-sold' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: ORDERS_SOURCE_ID,
    },
    {
      ...
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-chart2-stock-by-category' },
    },
    // Page 3 (Logistics) KPI date filters
    {
      ...
      isDashboardDateRange: true as const,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-kpi3-items-shipped' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
    ...
    },
    {
      ...
      isDashboardDateRange: true as const,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-kpi3-ontime' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: SHIPMENTS_SOURCE_ID,
    },
    {
      ...
      filterSourceId: ORDERS_SOURCE_ID,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-chart3-orders-by-country' },
    },
    // Page 4 (Customers)
    {
      ...
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-kpi4-enterprise' },
    },
    {
      ...
      filterSourceId: ORDERS_SOURCE_ID,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-chart4-top-customers' },
    },
    {
      ...
      filterSourceId: ORDERS_SOURCE_ID,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-grid4-top-customers' },
    },
    // Page 6 KPI date filters — "Last 12 months" window for CRM Pipeline KPIs
    {
      ...
      isDashboardDateRange: true as const,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-kpi6-open-deals' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
    ...
    },
    {
      ...
      isDashboardDateRange: true as const,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-kpi6-pipeline-value' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: CRM_DEALS_SOURCE_ID,
    },
    {
      ...
      isDashboardDateRange: true as const,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-kpi6-win-rate' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
      filterSourceId: CRM_DEALS_SOURCE_ID,
    },
    // Page 7 KPI date filter — "Last 12 months" window for Activities Logged trend
    {
      ...
      isDashboardDateRange: true as const,
      scopeV2: { kind: 'widget' as const, widgetId: 'widget-kpi7-open-activities' },
      dateRangePreset: 'last_12_months' as const,
      fieldType: 'date' as const,
