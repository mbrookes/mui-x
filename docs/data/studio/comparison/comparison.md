...
| Widget resize              | ✅ (col-span drag handle, snaps to 12-column grid) | ✅ (drag handle, snaps to grid) |
...
| Custom widget API                             | ❌                                                    | ✅                                 |
| Localisation / i18n                           | ✅ (`StudioLocaleText`; ptBR locale included)         | ✅ (`localeText`; 31 bundled locales) |
