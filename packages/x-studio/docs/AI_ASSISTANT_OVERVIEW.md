...
| `data`          | `StudioAIDataConfig?`    | App-provided `queryDataSource` callback for the `query_data_source` tool. When set, the AI can run structured (no raw SQL) queries and incorporate live data into responses.                                                                                                                                                           |
