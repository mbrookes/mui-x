...
export const frLocaleText: Partial<StudioLocaleText> = {
  ...
  filterLinkToField: 'Lien vers le champ',
  filterRemoveFieldLink: 'Supprimer le lien vers le champ',
  ...
  filterMetricRowLabel: 'Ligne métrique',
  filterMetricHelperText: 'Identifie la ligne dans le tableau des statistiques commerciales',
  filterFieldLabel: 'Champ',
  filterRankByLabel: 'Trier par',
  filterMetricCurrentValue: 'Valeur actuelle :',
